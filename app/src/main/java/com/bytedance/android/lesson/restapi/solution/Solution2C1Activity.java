...
public class Solution2C1Activity extends AppCompatActivity {
    ...
    private Call<List<Cat>> call = null;
    ...
    public void requestData(View view) {
        ...
        Call<List<Cat>> catListCall = retrofit.create(ICatService.class).randomCat(5);
        call = catListCall;
        catListCall.enqueue(new Callback<List<Cat>>() {
            @Override
